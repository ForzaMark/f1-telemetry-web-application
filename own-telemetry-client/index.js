...
client.on(PACKETS.participants, function (participants) {
    client.on(PACKETS.lapData, function (lapData) { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = mapToJoinedType(participants, lapData);
                    return [4 /*yield*/, axios_1["default"].post("http://localhost:8999/data", data)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
